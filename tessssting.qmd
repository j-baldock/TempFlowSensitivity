...
```{r}
DT::datatable(dat %>% group_by(basin, basin_code, site_name, site_code) %>% summarise(n = n()) )
```
...
Save to file
```{r eval=FALSE}
saveRDS(fit_ed, "Model objects/LetcherTempModel_EcoDrought_hierarchical_full.RDS")
```

Read in fitted model object
```{r}
fit_ed <- readRDS("Model objects/LetcherTempModel_EcoDrought_hierarchical_full.RDS")
```
...
MCMCtrace(top_mod, ind = TRUE, 
          params = c("B.0", "B.site", "B.basin", "mu.B", "B.year", 
                     "ar1", "alpha.0", "alpha.1",
                     "sigma"), pdf = FALSE)
```
...
mysites <- dat %>% group_by(site_code) %>% summarize(site_name = unique(site_name)) %>% ungroup() %>% arrange(site_code) %>% pull(site_name)
mysites
```
...
ggfit %>%
  filter(Parameter %in% c("B.site[1,1]", "B.site[2,1]", "B.site[3,1]", "B.site[4,1]", "B.site[5,1]",
                          "B.site[6,1]", "B.site[7,1]", "B.site[8,1]", "B.site[9,1]", "B.site[10,1]")) %>%
...
ggfit %>%
  filter(Parameter %in% c("B.site[1,2]", "B.site[2,2]", "B.site[3,2]", "B.site[4,2]", "B.site[5,2]",
                          "B.site[6,2]", "B.site[7,2]", "B.site[8,2]", "B.site[9,2]", "B.site[10,2]")) %>%
...
ggfit %>%
  filter(Parameter %in% c("B.site[1,3]", "B.site[2,3]", "B.site[3,3]", "B.site[4,3]", "B.site[5,3]",
                          "B.site[6,3]", "B.site[7,3]", "B.site[8,3]", "B.site[9,3]", "B.site[10,3]")) %>%
...
ggfit %>%
  filter(Parameter %in% c("B.site[1,4]", "B.site[2,4]", "B.site[3,4]", "B.site[4,4]", "B.site[5,4]",
                          "B.site[6,4]", "B.site[7,4]", "B.site[8,4]", "B.site[9,4]", "B.site[10,4]")) %>%
...
ggs_caterpillar(ggfit %>% filter(Parameter %in% c("ar1[1]", "ar1[2]", "ar1[3]", "ar1[4]", "ar1[5]",
                          "ar1[6]", "ar1[7]", "ar1[8]", "ar1[9]", "ar1[10]")) %>%
...
ggfit %>%
  filter(Parameter %in% c("B.site[1,2]", "B.site[2,2]", "B.site[3,2]", "B.site[4,2]", "B.site[5,2]",
                          "B.site[6,2]", "B.site[7,2]", "B.site[8,2]", "B.site[9,2]", "B.site[10,2]",
                          "B.site[11,2]", "B.site[12,2]", "B.site[13,2]", "B.site[14,2]", "B.site[15,2]",
                          "B.site[16,2]", "B.site[17,2]", "B.site[18,2]")) %>%
  mutate(Parameter = factor(Parameter, levels = c("B.site[1,2]", "B.site[2,2]", "B.site[3,2]", "B.site[4,2]", "B.site[5,2]",
                          "B.site[6,2]", "B.site[7,2]", "B.site[8,2]", "B.site[9,2]", "B.site[10,2]",
                          "B.site[11,2]", "B.site[12,2]", "B.site[13,2]", "B.site[14,2]", "B.site[15,2]",
                          "B.site[16,2]", "B.site[17,2]", "B.site[18,2]"))) %>%
  ...
  filter(Parameter %in% c("B.site[1,3]", "B.site[2,3]", "B.site[3,3]", "B.site[4,3]", "B.site[5,3]",
                          "B.site[6,3]", "B.site[7,3]", "B.site[8,3]", "B.site[9,3]", "B.site[10,3]",
                          "B.site[11,3]", "B.site[12,3]", "B.site[13,3]", "B.site[14,3]", "B.site[15,3]",
                          "B.site[16,3]", "B.site[17,3]", "B.site[18,3]")) %>%
  mutate(Parameter = factor(Parameter, levels = c("B.site[1,3]", "B.site[2,3]", "B.site[3,3]", "B.site[4,3]", "B.site[5,3]",
                          "B.site[6,3]", "B.site[7,3]", "B.site[8,3]", "B.site[9,3]", "B.site[10,3]",
                          "B.site[11,3]", "B.site[12,3]", "B.site[13,3]", "B.site[14,3]", "B.site[15,3]",
                          "B.site[16,3]", "B.site[17,3]", "B.site[18,3]"))) %>%
  ...
  mutate(site_name = mysites) %>%
    select(-Parameter)) %>%
  ggplot(aes(x = tempeff, y = floweff)) + geom_point(color = c(rep("red", times = 9), rep("blue", times = 9))) +
  geom_smooth(method = "lm") +
...
```{r}
temp.pars <- c("B.site[1,2]", "B.site[2,2]", "B.site[3,2]", "B.site[4,2]", "B.site[5,2]", "B.site[6,2]", "B.site[7,2]", "B.site[8,2]", "B.site[9,2]", "B.site[10,2]", "B.site[11,2]", "B.site[12,2]", "B.site[13,2]", "B.site[14,2]", "B.site[15,2]", "B.site[16,2]", "B.site[17,2]", "B.site[18,2]")
flow.pars <- c("B.site[1,3]", "B.site[2,3]", "B.site[3,3]", "B.site[4,3]", "B.site[5,3]", "B.site[6,3]", "B.site[7,3]", "B.site[8,3]", "B.site[9,3]", "B.site[10,3]", "B.site[11,3]", "B.site[12,3]", "B.site[13,3]", "B.site[14,3]", "B.site[15,3]", "B.site[16,3]", "B.site[17,3]", "B.site[18,3]")
int.pars <- c("B.site[1,4]", "B.site[2,4]", "B.site[3,4]", "B.site[4,4]", "B.site[5,4]", "B.site[6,4]", "B.site[7,4]", "B.site[8,4]", "B.site[9,4]", "B.site[10,4]", "B.site[11,4]", "B.site[12,4]", "B.site[13,4]", "B.site[14,4]", "B.site[15,4]", "B.site[16,4]", "B.site[17,4]", "B.site[18,4]")
...
mydf <- ggfit %>%
  ...
  ungroup() %>%
  mutate(site_name = mysites) %>%
  left_join(dat %>% group_by(site_name) %>% summarize(basin = unique(basin), area_sqmi = unique(area_sqmi))) %>% 
